...
def get_maintenance_status():
    maint_file = 'maintenance_status.json'
...
def get_config():
    config_file = '/home/zaco/zpotify1/config.env'  # Full path to your config file
    if os.path.exists(config_file):
        with open(config_file, 'r') as f:
            return f.read()
    return "Config file not found at " + config_file
...
def dashboard():
    ...
    return render_template('dashboard.html', 
                         ...
                         maintenance=maintenance)
import json
with open('/home/zaco/zpotify1/user_info.json') as f:
...
def users_page():
    ...
    try:
        with open('/home/zaco/zpotify1/user_info.json', 'r') as f:
